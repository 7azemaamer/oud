class FloatingCartSidebar {
    ...
    if (cartItems) {
      cartItems.innerHTML = `
        <div style="padding: 24px;">
          <salla-cart-summary class="header-rounded-btn hydrated"><!---->
            <a class="s-cart-summary-wrapper" href="https://moreoover.com/cart">
              <div id="s-cart-icon">
                <slot-fb name="icon" hidden="">
                  <i class="s-cart-summary-icon"><!-- Generated by IcoMoon.io -->
              ...
              <p class="s-cart-summary-content">
                <b class="s-cart-summary-total">0 <i class="sicon-sar"></i></b>
              </p>
            </a>
          </salla-cart-summary>
        </div>
  ...
  bindEvents() {
    // Cart button click event - use existing cart button
    ...
    // Close button click - use existing close button
    document.addEventListener("click", (e) => {
    ...
    // Overlay click - use existing overlay
    document.addEventListener("click", (e) => {
